...
const App = () => {
  ...
  const submitForm = () => {
    const newPizza = {
      ...
      toppings: ['pepperoni','sausage','canadian_bacon','spicy_italian_sausage','grilled_chicken','onions','green_pepper','diced_tomatos','black_olives','roasted_garlic','artichoke_hearts','three_cheese','pineapple','extra_cheese'].filter(topping => !!formValues[topping]),
